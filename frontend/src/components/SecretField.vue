<template>
  <div class="relative">
    <input
      ...
      :disabled="disabled"
      :autocomplete="asPassword ? 'new-password' : 'off'"
      :name="asPassword ? undefined : `field-${uid}`"
      autocapitalize="off"
      autocorrect="off"
      spellcheck="false"
      data-lpignore="true"
      ...
      :class="{ 'secret-masked': !asPassword && !visible }"
...
const props = defineProps({
  ...
  asPassword: { type: Boolean, default: false }
})
